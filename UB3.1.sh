...
#sudo find /DIRECTORY -type f -name "*.FILETYPE"
sudo find /DIRECTORY -type f -name "*.m4b";
sudo find /DIRECTORY -type f -name "*.mp3";
sudo find /DIRECTORY -type f -name "*.mp4";
sudo find /DIRECTORY -type f -name "*.aax";
sudo find /DIRECTORY -type f -name "*.wav";
